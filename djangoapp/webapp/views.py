...
class VehiculesDeleteView(DeleteView):
    ...
    success_url = '/vehicules/'  # URL to redirect after deletion

# Employe views (similar structure as Vehicules views)
...
class EmployeDeleteView(DeleteView):
    ...
    success_url = '/employe/'  # URL to redirect after deletion
